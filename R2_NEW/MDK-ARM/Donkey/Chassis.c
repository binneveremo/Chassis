...
void Chassis_Velocity_Out(float left, float front, float anticlock)
{
	...
	chassis.motor.drive[front_wheel].left = left + anticlock;

	chassis.motor.drive[left_wheel].front = front - anticlock;
	chassis.motor.drive[left_wheel].left = left;

	chassis.motor.drive[right_wheel].front = front + anticlock;
	chassis.motor.drive[right_wheel].left = left;

	chassis.motor.drive[behind_wheel].front = front;
	chassis.motor.drive[behind_wheel].left = left - anticlock;
