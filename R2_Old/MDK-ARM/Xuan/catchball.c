...
// Target Positions
float Init_Pos = 16;
float CatchBall_Pos = 23;
float Defend_Pos = 123;
float PreDunk_Pos = 32;
...
float Kp_Hold[7] =   {0.023,      0.55,         0.55,   0.4,     0.023,      0.55 }; 
float Kd_Hold[7] =   {0,          0.04,         0.05,   0.06,    0,          0.05 };      
float Trq_Hold[7]=   {0,          2,            3.0,    1.0,     0,          0    };           
float Pos_Target[7]= {16,         25,           123,    32,      16,         123  }; 
